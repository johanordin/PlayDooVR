...
testMesh::testMesh(glm::vec3 _pos, float _mass, float _rad)
{
	position = _pos;
	mass = _mass;
	radius = _rad;
...
testMesh::~testMesh(void)
{
	cout << "A sphere has died" << endl;
}


void testMesh::createTestMesh(float radius, int segments) {
...
void testMesh::display(ostream& os) const{
